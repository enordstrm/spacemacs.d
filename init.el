...
values."
  (setq-default
   ...
   dotspacemacs-excluded-packages '(yasnippet auto-yasnippet helm-c-yasnippet)
...
values."
  ...
  (setq-default
   ...
   dotspacemacs-themes '(doom-one-custom
                         atom-one-dark
                         atom-one-light
                         spacemacs-dark
                         spacemacs-light
...
`dotspacemacs/user-config' first."
  ...
  (push "~/.spacemacs.d/themes/" load-path)
...
you should place your code here."
  ...
  ;; Disable auto company auto complete in favor of on-demand (keybinding)
